...
@implementation TimelineBranchArcLeft
...
- (void)drawRect:(CGRect)rect
{
	...
	CGContextAddEllipseInRect(context, CGRectMake(- rect.size.width + 1.0f, 1.0f, rect.size.width * 2.0f, rect.size.height * 2.0f));
