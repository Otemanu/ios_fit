...
{
    static NSString *CellIdentifier = @"PoseTableViewCell";
    PoseTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:CellIdentifier forIndexPath:indexPath];
    cell.posesTableCellLabel.text = [NSString stringWithFormat:@"Pose %d", indexPath.row];
    return cell;
}
